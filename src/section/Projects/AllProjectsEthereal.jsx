...
import styles from "./AllProjectsEthereal.module.css";
      ...
      <div className={`${styles.projectCard} ${styles.inProgressCard}`}>
        ...
        <div className={styles.techTags}>
          {project.keyTech.map((tech, idx) => (
            <span key={tech}>
              {tech}
              {idx < project.keyTech.length - 1 && <i aria-hidden="true"> · </i>}
            </span>
          ))}
        </div>
      </div>
      ...
      <div className={styles.pageInner}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            exploring {projects.length} projects across web applications and
...
export default AllProjectsEthereal;
