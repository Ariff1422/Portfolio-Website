...
import styles from "./NavbarJdm.module.css";
import { useTheme } from "../../common/ThemeContext";

const THEME_META = {
  jdm: { code: "01_J2K", label: "高速起動", short: "J2K" },
  bauhaus: { code: "02_BAU", label: "DESIGN", short: "BAU" },
  "mystical-western": { code: "03_WSTN", label: "FOLKLORE", short: "WSTN" },
  ethereal: { code: "04_ETHR", label: "CELESTIAL", short: "ETHR" },
};
      ...
      {QUADRANT_ORDER.map((id) => {
        ...
        return (
          <button
            ...
            className={`${styles.quadrantNode} ${styles[`q${meta.short}`]} ${
          ...
          >
            <span className={styles.quadCode}>{meta.code}</span>
            <span className={styles.quadLabel}>
              {isBuilt ? meta.label : "LOCKED"}
            </span>
          </button>
        );
      })}
